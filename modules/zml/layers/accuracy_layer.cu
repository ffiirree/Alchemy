...
template<typename T>
void AccuracyLayer<T>::ForwardGPU(const vector<container_type *> &input,
...
template void AccuracyLayer<float>::ForwardGPU(const vector<container_type *> &input, const vector<container_type *> &output);
template void AccuracyLayer<double>::ForwardGPU(const vector<container_type *> &input, const vector<container_type *> &output);
}