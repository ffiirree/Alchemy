...
int main()
{
    ...
    std::cout << z::abs(z::Matrix8s(3, 5, 3, { -1, 2, 255})) << std::endl;
    z::Matrix _r;
    z::absdiff(roi, z::Matrix(3, 10, 3, { 0, 2, 255}), _r);
    std::cout << _r << std::endl;

    z::Matrix add_r;
    z::Matrix mask(3, 10, 3, {0});
    auto mask_roi = mask(z::Rect(1, 1, 2, 2));
    mask_roi = z::Scalar{1, 1, 1};
    std::cout << mask << std::endl;
    z::add(roi, z::Matrix(3, 10, 3, {100, 100, 100}), add_r, mask);
